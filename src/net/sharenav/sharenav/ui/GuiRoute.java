...
public class GuiRoute extends Form implements CommandListener, ItemCommandListener {
	...
	private static final Command CMD_SETUP_OK = new Command(Locale.get("generic.OK")/*Ok*/, ShareNavMenu.OK, 2);
	private static final Command CMD_SETUP_CANCEL = new Command(Locale.get("generic.Cancel")/*Cancel*/, ShareNavMenu.BACK, 3);
	...
	public GuiRoute(ShareNavDisplayable parent, boolean useAsSetupDialog) {
