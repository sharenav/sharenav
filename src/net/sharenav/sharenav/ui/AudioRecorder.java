...
public class AudioRecorder  implements SelectionListener{
	...
	public boolean startRecorder() {
		...
		try{
			...
			//#endif
			String fileSubPart = "ShareNav-" + HelperRoutines.formatSimpleDateSecondNow();
			//#if polish.android
			// with the normal line tries to open /file:/sdcard/ShareNav-201.. and fails
			//
			// skip /file: prefix
			...
			// W/System.err(11824):    at net.sharenav.sharenav.ui.AudioRecorder.startRecorder(AudioRecorder.java:95)
			//#else
