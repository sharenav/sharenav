/*
 * ShareNav - Copyright (c) 2008 Jyrki Kuoppala jkpj at users dot sourceforge dot net 
 * See Copying
...
public class TouchHelper extends KeyCommandCanvas implements CommandListener,
	...
	public TouchHelper(ShareNavDisplayable parent) {
		...
		if (e != null) {
			...
			if (eleId != -1 && eleId < helpEle.length) {
				...
				if (eleId != 5) {
					...
					if (eleId == 1) {
						ShareNav.getInstance().alert(Locale.get("traceiconmenu.HelpPage"),
