/*
 * ShareNav - Copyright (c) 2009 Kai Krueger apm at users dot sourceforge dot net 
 * 
...
public class GuiGpxOsmUpload extends Form implements ShareNavDisplayable, CommandListener, ExportSession{
	...
	public void upload() throws IOException{
		...
		try {
			...
			connection.setRequestProperty("User-Agent", "ShareNav");
	...
	public synchronized void commandAction(Command c, Displayable d) {
		if (c == OK_CMD) {
			...
			ShareNav.getInstance().showPreviousDisplayable();
			notifyAll();
		}
		if (c == BACK_CMD) {
			proceed = false;
