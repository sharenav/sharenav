...
import net.sharenav.util.ETRSTM35FINconvert;
//#endif
						...
						if (layersToRender[layer] == Tile.LAYER_HIGHLIGHT /*(0 | Tile.LAYER_HIGHLIGHT) pointless bitwise operation*/) {
							...
							*/
							if (createPC.waysPainted != 0) {
								...
								// Update 2011-06-11: Might be fixed with the patch from gojkos at [ sharenav-Bugs-3310178 ] Delayed map draw on LG cookie phone
