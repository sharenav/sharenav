package net.sharenav.util.qdxmlparser;
 ...
 * 
 * This parser is, like the SAX parser,
 * an event based parser, but with much less functionality.
 * It is used when JSR-172 is not available.
 * 
 * based on http://www.javaworld.com/javatips/jw-javatip128_p.html
 * used with kind permission by Steven R. Brandt
 * 
 */
