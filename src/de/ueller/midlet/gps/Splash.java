...
public class Splash extends Canvas implements CommandListener,Runnable{
	...
	String[] txt = {
		"Disclaimer:"/* i:Discl1 */,
		" No warranty, no liability."/* i:Discl2 */,
		" Don't handle while driving!"/* i:Discl3 */,
		" Only use if legally allowed"/* i:Discl4 */,
		" to use the features under"/* i:Discl5 */,
		" for you applicable laws."/* i:Discl6 */,
		...
		" licensed under GPL2"/* i:Application2 */,
		" http://www.gnu.org/"/* i:Application3 */,
		"Map data:"/* i:MapData */,
		" from OpenStreetMap"/* i:MapData2 */,
		" licensed under CC 2.0"/* i:MapData3 */,
		" http://creativecommons.org/"/* i:MapData4 */,
