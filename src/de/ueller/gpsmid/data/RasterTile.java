...
public class RasterTile implements UploadListener {
	// public static final byte RASTER_TILE_FLAG_NAME = 1;
	private int zoom = 0;
	private int x = 0;
	private int y = 0;
	private int xDiff = 0;
