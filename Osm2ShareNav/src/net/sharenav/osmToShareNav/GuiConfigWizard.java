...
public class GuiConfigWizard extends JFrame implements Runnable, ActionListener, SelectionListener {
	...
	public void setupWizard() {
		...
		jcbSoundFormats.setToolTipText("Select sound formats to include into the midlet, e.g. most Windows Mobile devices support .wav but cannot replay .amr. ShareNav will use the first successful playing sound format included");
		gbc.gridx = 0;
		gbc.gridy = 1;
		gbc.weighty = 0;
		...
		jbCreate = new JButton("Create ShareNav midlet or apk");
	...
	private void handleHelpClicked() {
		...
		jepHelpMsg.setText(
			...
			"<br>" +
			"Osm2ShareNav is a conversion program to package map data from <a href=\"http://www.openstreetmap.org\">OpenStreetMap</a> into a 'midlet' called ShareNav.\n" +
			...
			"<li> Press 'Create ShareNav midlet' or 'Create ShareNav map zip'\n" +
			"</ol><br>" +
	...
	/** Used to reenable the "Close" button from BundleShareNav (after Midlet creation).
	 */
