...
espeak -a180 -wzum.wav -z -p79 -s200 -vde+%voice% -x -k5 "zum"
espeak -a180 -wauf_autobahn.wav -z -p79 -s200 -vde+%voice% -x -k5 "auf die Autobahn fahren"
espeak -a180 -wdie.wav -z -p79 -s200 -vde+%voice% -x -k5 "die"
espeak -a180 -wautobahn_verlassen.wav -z -p79 -s200 -vde+%voice% -x -k5 "Autobahn verlassen"
...
espeak -a180 -whalten.wav -z -p79 -s150 -vde+%voice% -x -k5 "halten"
