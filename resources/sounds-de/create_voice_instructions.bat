...
espeak -a180 -w%lang%abfahrt.wav -z -p79 -s200 -vde+f1 -x -k5 "Abfahrt"
...
espeak -a180 -w%lang%neue_route.wav -z -p79 -s180 -vde+f1 -x -k5 "Neuberechnung der Route"
espeak -a180 -w%lang%geschwindigkeit.wav -z -p79 -s200 -vde+f1 -x -k5 "Bitte nicht so schnell!"
